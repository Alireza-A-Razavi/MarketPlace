...
urlpatterns = [
   ...
   path('profile/<pk>/', views.ProfileRUDView.as_view(), name='profile'),
   path('profile-creation/', views.ProfileCreateView.as_view(), name='profile_creation'),
   path('producer-profile-creation/', views.ProfileCreateView.as_view(), name="producer_profile_creation"),
